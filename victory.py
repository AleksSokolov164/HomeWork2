...
while answer=="да":
    ...
    if born_year_Rimskiy_Korsakov == 1844:
        n = n + 1
    print("Количество правильных ответов=", n,"Количество неправильных ответов =", 6-n,\
          "Процент правильных ответов=", str((n*100)/6)+"%","Процент неправильных ответов=", str(100-(n*100)/6)+"%")
